...
export default function Menu() {
    const [selectedCategory, setSelectedCategory] = useState('desserts'); // Default to desserts
            ...
            <div className="w-full px-4 md:px-8 py-8 bg-amber-200 flex flex-col items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-black-500 text-lg pt-2">
                        Explore our mouthwatering menu filled with flavorful options to<br />  satisfy every craving.
                    </p>
                </div>
                ...
                <div className="flex flex-row gap-4 mt-4">
                    <button
                        ...
                        className={`w-44 h-16 text-lg text-black-500 font-bold border-4 border-black rounded-full border-b-8 border-r-4 flex items-center justify-center gap-2 hover:border-b-2 hover:border-r-2 ${selectedCategory === 'burgers' ? 'bg-pink-500 text-white' : 'bg-transparent'}`}
                    >
                        BURGERS
                    </button>
                    <button
                        onClick={() => handleCategoryChange('sides')}
                        className={`w-44 h-16 text-lg text-black-500 font-bold border-4 border-black rounded-full border-b-8 border-r-4 flex items-center justify-center gap-2 hover:border-b-2 hover:border-r-2 ${selectedCategory === 'sides' ? 'bg-pink-500 text-white' : 'bg-transparent'}`}
                    >
                        SIDES
                    </button>
                    <button
                        onClick={() => handleCategoryChange('desserts')}
                        className={`w-44 h-16 text-lg text-black-500 font-bold border-4 border-black rounded-full border-b-8 border-r-4 flex items-center justify-center gap-2 hover:border-b-2 hover:border-r-2 ${selectedCategory === 'desserts' ? 'bg-pink-500 text-white' : 'bg-transparent'}`}
                    >
                        DESSERTS
                    </button>
                </div>
